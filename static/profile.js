...
var updateFirstName = function () {
  ...
  var newText = encodeURIComponent(document.getElementById('FirstName').value);
...
var updateLastName = function () {
  ...
  var encodeURIComponent(newText = document.getElementById('LastName').value);
...
var updateEmail = function () {
  ...
  var newText = encodeURIComponent(document.getElementById('Email').value);
...
var updatePhone = function () {
  ...
  var newText = encodeURIComponent(document.getElementById('Phone').value);
...
var updateBio = function () {
  ...
  var newText = encodeURIComponent(document.getElementById('newBio').value);
